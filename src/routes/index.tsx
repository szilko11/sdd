                  ...
                  return (
                    <Button
                      ...
                      className={cn(
                        ...
                        "group relative z-20 h-full w-full min-w-0 justify-start overflow-hidden rounded-md border border-border/80 bg-tile p-0 text-left text-foreground shadow-tile backdrop-blur-md transition-all duration-200 hover:border-red-500 hover:bg-tile-active hover:shadow-[0_0_28px_rgba(239,68,68,0.38)] focus-visible:border-primary",
                        "border-red-500/40",
                    ...
                    >
                      ...
                      <div
                        className="pointer-events-none absolute inset-x-0 top-0 z-30 h-[2px] bg-gradient-to-r from-transparent via-red-500 to-transparent opacity-0 transition-opacity duration-300 laser-sweep-active group-hover:opacity-100"
                      />

                      {/* Top slide-out warning micro-ribbon that drops down from the top edge */}
                      <div
                        className="pointer-events-none absolute inset-x-0 top-0 z-20 overflow-hidden transform transition-all duration-250 ease-out -translate-y-full opacity-0 group-hover:translate-y-0 group-hover:opacity-100"
                      >
                      ...
                      <div className="absolute inset-0 overflow-hidden rounded-md pointer-events-none">
                        ...
                        <div
                          className="absolute inset-0 bg-red-950/40 opacity-70 group-hover:opacity-95 group-hover:bg-red-950/60 transition-colors"
                        />
                      </div>
                      ...
                      <div className="relative z-10 flex h-full w-full items-center justify-between px-3.5 py-1.5">
                        <div className="flex items-center gap-2.5 min-w-0">
                          <span
                            className="grid size-7 shrink-0 place-items-center rounded border border-red-500/60 bg-red-950/70 text-red-400 backdrop-blur-sm transition-all duration-200 group-hover:scale-110 group-hover:border-red-400 group-hover:bg-red-800/80 group-hover:text-white group-hover:shadow-[0_0_14px_rgba(239,68,68,0.7)]"
                          >
                          ...
                          <div className="min-w-0">
                            <div className="flex items-center gap-1.5">
                              <span
                                className="font-mono text-[8.5px] uppercase tracking-wider text-red-400 font-bold group-hover:text-red-300 transition-colors"
                              >
                                SZERVER
                              </span>
                              <span
                                className="font-display text-xs font-bold uppercase tracking-wider text-white group-hover:text-red-200 group-hover:drop-shadow-[0_0_8px_rgba(239,68,68,0.8)] transition-all"
                              >
                                {tile.title}
                              </span>
                            </div>
                        ...
                        <div className="flex items-center gap-2 shrink-0">
                          <span
                            className="rounded bg-black/70 px-2 py-0.5 font-mono text-[8px] font-bold uppercase tracking-wider text-red-300/90 border border-red-500/40 group-hover:border-red-400 group-hover:bg-red-950/90 group-hover:text-red-100 group-hover:shadow-[0_0_10px_rgba(239,68,68,0.6)] transition-all"
                          >
                            {tile.badge}
                          </span>
                          <ArrowLeft
                            className="rotate-180 text-red-400/80 opacity-0 transition-all duration-200 group-hover:translate-x-0.5 group-hover:opacity-100 group-hover:text-red-200"
                            size={14}
                            aria-hidden="true"
                          />
                        </div>
